...
type InstanceProperties = {
    debouncedSearch: (
        | DebouncedMethod<typeof BeneficiaryEditSelectCompany, 'search'>
        | undefined
    ),
};
...
const BeneficiaryEditSelectCompany = defineComponent({
    name: 'BeneficiaryEditSelectCompany',
    props: {
        defaultCompany: {
    ...
    render() {
        ...
        return (
            <div class="BeneficiaryEditSelectCompany">
                <Select
                    value={value}
                    options={options}
                    placeholder={__('page.beneficiary-edit.type-to-search-company')}
                    class="BeneficiaryEditSelectCompany__select"
                ...
                {(value !== null) && (
                    <Button
                        class="BeneficiaryEditSelectCompany__edit-button"
                        icon="edit"
                        type="default"
                        to={{
                            name: 'edit-company',
...
export default BeneficiaryEditSelectCompany;

...
type InstanceProperties = {
    debouncedSearch: (
        | DebouncedMethod<typeof EstimateCreateStepBuyerAndLinesBuyerSelect, 'search'>
        | undefined
    ),
};
...
/** Champ de sélection d'un acheteur pour la création d'un devis. */
const EstimateCreateStepBuyerAndLinesBuyerSelect = defineComponent({
    name: 'EstimateCreateStepBuyerAndLinesBuyerSelect',
    props: {
        value: {
    ...
    methods: {
        ...
        __(key: string, params?: Record<string, number | string>, count?: number): string {
            if (!key.startsWith('global.')) {
                ...
                key = key.replace(/^modal\./, 'modal.estimate-create.');
            } else {
    ...
    render() {
        ...
        const renderContent = (): JSX.Element => {
                    ...
                    <Select
                        ...
                        renderer={(option: Option<Beneficiary['id'], Beneficiary>) => {
                            ...
                            if (beneficiary!.is_invoiceable) {
                                return (
                                    <span class="EstimateCreateStepBuyerAndLinesBuyerSelect__option">
                                        <span class="EstimateCreateStepBuyerAndLinesBuyerSelect__option__label">
                                            {label}
                                        </span>
                                    </span>
                                );
                            ...
                            return (
                                <span
                                    class={[
                                        'EstimateCreateStepBuyerAndLinesBuyerSelect__option',
                                        'EstimateCreateStepBuyerAndLinesBuyerSelect__option--not-invoiceable',
                                    ]}
                                    v-tooltip={(
                                ...
                                >
                                    ...
                                    <span class="EstimateCreateStepBuyerAndLinesBuyerSelect__option__warning">
            ...
            return (
                <div class="EstimateCreateStepBuyerAndLinesBuyerSelect__selected">
                    <div class="EstimateCreateStepBuyerAndLinesBuyerSelect__selected__info">
                        <span class="EstimateCreateStepBuyerAndLinesBuyerSelect__selected__name">
                            <span class="EstimateCreateStepBuyerAndLinesBuyerSelect__selected__name__value">
                                {company !== null ? company.legal_name : value.full_name}
                            </span>
                        </span>
                        {company !== null && (
                            <span class="EstimateCreateStepBuyerAndLinesBuyerSelect__selected__contact">
                                {__('global.contact-name', { name: value.full_name })}
                            </span>
                        )}
                        {address !== null && (
                            <address class="EstimateCreateStepBuyerAndLinesBuyerSelect__selected__address">
                                {address}
                            </address>
                        )}
                    </div>
        ...
        return (
            <div class="EstimateCreateStepBuyerAndLinesBuyerSelect">
                {renderContent()}
            </div>
        );
    },
...
export default EstimateCreateStepBuyerAndLinesBuyerSelect;

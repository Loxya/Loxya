...
/** Étape 1 de la création d'un devis : Acheteur et lignes. */
const EstimateCreateStepBuyerAndLines = defineComponent({
    name: 'EstimateCreateStepBuyerAndLines',
    props: {
        data: {
    ...
    methods: {
        ...
        handleBuyerChange(buyer: Beneficiary | null) {
            ...
            //   du devis dessus. Sinon, on conserve la langue courante.
    ...
    render() {
        ...
        return (
            <div class="EstimateCreateStepBuyerAndLines">
                <div class="EstimateCreateStepBuyerAndLines__body">
                    <FormField
                        type="custom"
                        class="EstimateCreateStepBuyerAndLines__buyer"
                    ...
                    <div class="EstimateCreateStepBuyerAndLines__lines">
                        <div class="EstimateCreateStepBuyerAndLines__lines__title">
                            {__('fields.lines.label')}
                        </div>
                        <div class="EstimateCreateStepBuyerAndLines__lines__body">
                            <BillingEditor
                ...
                <div class="EstimateCreateStepBuyerAndLines__actions">
...
export default EstimateCreateStepBuyerAndLines;

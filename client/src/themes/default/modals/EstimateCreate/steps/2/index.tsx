...
/** Étape 2 de la création du devis : Autres informations. */
const EstimateCreateStepOtherInformations = defineComponent({
    name: 'EstimateCreateStepOtherInformations',
    props: {
        data: {
    ...
    render() {
        ...
        return (
            <form class="EstimateCreateStepOtherInformations" onSubmit={handleSubmit}>
                <div class="EstimateCreateStepOtherInformations__body">
                    <div class="EstimateCreateStepOtherInformations__group">
                        <FormField
                            type="select"
                            label={__('fields.lang.label')}
                            class="EstimateCreateStepOtherInformations__group__field"
                            value={data.lang}
                            options={langOptions}
                            error={errors?.lang}
                            placeholder={false}
                ...
                <div class="EstimateCreateStepOtherInformations__actions">
                    <Button
                    ...
                    <div class="EstimateCreateStepOtherInformations__actions__main">
...
export default EstimateCreateStepOtherInformations;

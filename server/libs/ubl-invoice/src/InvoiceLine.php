...
class InvoiceLine implements XmlSerializable, XmlDeserializable
{
    ...
    /**
     * Get the reference to a previous invoice that this line relates to.
     */
    ...
    /**
     * Set the reference to a previous invoice that this line relates to.
     *
     * @return static
     */
    ...
    protected static function deserializedTag(array $mixedContent)
    {
        ...
        return (new static())
            ...
            ->setInvoicedQuantity((
                ReaderHelper::getTagValue(Schema::CBC . 'InvoicedQuantity', $collection) !== null
                    ? floatval(ReaderHelper::getTagValue(Schema::CBC . 'InvoicedQuantity', $collection))
                    : null
            ))
            ->setLineExtensionAmount((
                ReaderHelper::getTagValue(Schema::CBC . 'LineExtensionAmount', $collection) !== null

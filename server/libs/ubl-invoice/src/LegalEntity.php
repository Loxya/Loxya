...
class LegalEntity implements XmlSerializable, XmlDeserializable
{
    ...
    private ?string $companyIdSchemeId = null;
     ...
     * @return static
     */
    public function setCompanyId(?string $companyId, ?string $schemeId = null)
    {
        ...
        if ($this->companyId !== null) {
            $writer->write([
                [
                    ...
                    'attributes' => $this->companyIdSchemeId !== null
    ...
    public static function xmlDeserialize(Reader $reader)
    {
        ...
        return (new static())
            ...
            ->setCompanyId(
                ...
                $companyId['attributes']['schemeID'] ?? null,
            )
            ->setCompanyLegalForm(

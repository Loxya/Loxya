...
/**
 * Métadonnées pour les Terres australes et antarctiques françaises (TAAF).
 */
final class CountryMetadataTf extends CountryMetadataFr
{
    public static function isSameVatArea(Country $otherCountry): bool
    {
        return $otherCountry->getCode() === 'TF';
    }

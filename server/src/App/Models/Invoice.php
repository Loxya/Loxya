...
final class Invoice extends BaseModel implements Serializable, Pdfable
{
    ...
    public function toPdf(I18n $i18n): Pdf
    {
        ...
        return Pdf::createFromTemplate('invoice', $i18n, $filename, $this->getPdfData());
    }
    ...
    public static function createFromBooking(Event $booking, User $creator): Invoice
    {
        ...
        Assert::notEmpty($booking->materials, (
            "The booking must contain at least one material or line for an invoice to be generated from a booking."
        ));
        ...
        return dbTransaction(static function () use ($booking, $beneficiary, $creator) {
            ...
            $invoice->billingCompany()->associate($booking->billing_company);
